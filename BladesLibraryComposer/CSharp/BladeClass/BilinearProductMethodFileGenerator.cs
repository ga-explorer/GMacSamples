...
{
    internal sealed class BilinearProductMethodFileGenerator : BladesLibraryMacroCodeFileGenerator
    {
        ...
        protected override void SetTargetVariablesNames(GMacTargetVariablesNaming targetNaming)
        {
            ...
            BladesLibraryGenerator.SetBasisBladeToArrayNaming(targetNaming, "mv1", InputGrade1, "coefs1");
            BladesLibraryGenerator.SetBasisBladeToArrayNaming(targetNaming, "mv2", InputGrade2, "coefs2");
