...
{
    internal sealed class MiscMethodsFileGenerator : BladesLibraryCodeFileGenerator
    {
        ...
        private void GenerateMainSelfDpGradeFunction()
        {
            ...
            var selfDpGradeCasesText = new ListComposer(Environment.NewLine);
            ...
            TextComposer.Append(
                Templates["main_self_dp_grade"].GenerateUsing(selfDpGradeCasesText)
                );
        }
